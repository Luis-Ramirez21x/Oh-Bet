...
function BetCRUD({betData}){
    ...
    return(
        <>
        <div className='betCRUD' id={darkMode ? "dark" : ''}>
                <button type="button" className="btn btn-success darkCrud" onClick={acceptBet}>
                ...
                <button type="button" 
                className="btn btn-warning darkCrud"
                onClick={showForm}>
              ...
              <button type="button" className="btn btn-danger darkCrud" onClick={rejectBet}>
