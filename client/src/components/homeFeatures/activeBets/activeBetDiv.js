...
function ActiveBetDiv({betData,userId}){
    ...
    return(
        <div className="activeBets">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" className="bi bi-file-earmark-person" fill="currentColor" viewBox="0 0 16 16">
                ...
                <button type="button" className="btn winner-btn"  >
