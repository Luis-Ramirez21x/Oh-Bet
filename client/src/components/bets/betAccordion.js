                ...
                return (
                    <Accordion.Body key={index}>
                        ...
                        <a href={`/bet-details/${bet._id}`} className='accordion-btn'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill='currentColor' className="bi bi-arrow-bar-right" viewBox="0 0 16 16">
